...
val SfProText = FontFamily(
    ...
    Font(R.font.sf_pro_text_semibold, FontWeight.Medium),
...
private fun defaultTypography() = with(CinemyTypography()) {
    Typography(
...
internal val LocalCinemyTypography = staticCompositionLocalOf { CinemyTypography() }
